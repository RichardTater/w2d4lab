...
// const dividedNums = numbers.forEach((element) => console.log(element / 2))
...
// const dividedNumsArr = numbers.map((element) => element / 2)
// console.log(dividedNumsArr)
//DONE:
...
// const iCity = cities.filter((city) => city.endsWith('i'))

// const iCity = cities.filter((city) => city[city.length - 1] === 'i')
// console.log(iCity)
//DONE:
...
const meat = foods.filter((element) => element.tags.includes('meat')).reduce((accumulative, current) => accumulative + current.price, 0)
